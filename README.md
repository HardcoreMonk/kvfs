...
10. Multi-edge HA · EC stripe rebalance · Meta backup — 예정
...
- ADR-016 gRPC 이행 · ADR-017 Streaming PUT/GET
- ADR-018 Content-defined chunking · ADR-019 SIMD-accelerated RS
- ADR-020 Hybrid storage policy · ADR-021 LRC
- ADR-022 Multi-edge leader election · ADR-023 Auto-trigger rate limiting · ADR-024 EC stripe rebalance
