...
9. Auto-trigger · Streaming · LRC — 예정
...
- ADR-017 Streaming PUT/GET · ADR-018 Content-defined chunking
- ADR-019 SIMD-accelerated RS · ADR-020 Hybrid storage policy · ADR-021 LRC
