...
> **Go 1.26 · Apache 2.0 · Season 3 closed · 주말 프로젝트**
...
14. **Auto-snapshot scheduler** ← **Ep.6 완료** — edge ticker가 주기 snapshot + retention 회전 (ADR-016)
15. **Multi-edge HA** ← **Ep.7 완료, Season 3 close** — read-replica follower (snapshot-pull + atomic.Pointer hot-swap), write reject 503+X-KVFS-Primary (ADR-022)

### Season 4 (성능·효율 트랙, 예정)
16. Streaming PUT/GET · WAL/incremental backup · Content-defined chunking · Auto leader election — 후속
