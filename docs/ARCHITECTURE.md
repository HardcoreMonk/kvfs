...
| S1 ε | HMAC-SHA256 UrlKey | S3 SigV4, JWT, 원 legacy URL signature APR1+Base62 | stdlib only, timing-safe | [007](adr/ADR-007-urlkey-hmac-sha256.md) |
...
- Hot/Cold tier 자동 이동
- NFS/SMB 확장 (기존 reference의 legacy NFS gateway 경로 참조)
