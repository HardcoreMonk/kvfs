...
- **새 ADR**: `docs/FOLLOWUP.md` 의 P3-07 candidate (ADR-014 등) 또는 새 후보 제안 (PR 보다 먼저 issue로 제안)
...
- **성능 최적화 PR** — 가독성을 해치는 SIMD/inline assembly. ADR-019 후보로 별도
...
./scripts/demo-iota.sh     # chunking
./scripts/demo-kappa.sh    # Reed-Solomon EC
./scripts/demo-lambda.sh   # auto-trigger
...
5. blog episode 도입 시: 라이브 데모 출력을 markdown 에 embed (스크린샷 X)
